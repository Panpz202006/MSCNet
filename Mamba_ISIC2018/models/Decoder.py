...
class Decoder(nn.Module):
    def __init__(self,in_channels=16):
        ...
        self.decoder3=DecoderBlock(in_channels*8,high_level=True)
        self.decoder2=DecoderBlock(in_channels*4,high_level=True)
        self.decoder1=DecoderBlock(in_channels*2,high_level=True)

        self.cat3=Cat(in_channels*8,in_channels*8)
        self.cat2=Cat(in_channels*8,in_channels*4)
        self.cat1=Cat(in_channels*4,in_channels*2)
...
class Final_Projection(nn.Module):
    def __init__(self,in_channels=16):
        super().__init__()
        self.final4=Final_ProjectionBlock(in_channels*8,scale_factor=2**5)
        self.final3=Final_ProjectionBlock(in_channels*8,scale_factor=2**4)
        self.final2=Final_ProjectionBlock(in_channels*4,scale_factor=2**3)
        self.final1=Final_ProjectionBlock(in_channels*2,scale_factor=2**2)
