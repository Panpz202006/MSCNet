...
class VGG(nn.Module):
    ...
    def __init__(self, in_channels=[64,128,256,512,512],mode = 'rgb'):
        ...
        conv1 = nn.Sequential()
        conv1.add_module('conv1_1', nn.Conv2d(3, in_channels[0], 3, 1, 1))
        ...
        conv5.add_module('conv5_1', nn.Conv2d(in_channels[3], in_channels[3], 3, 1, 1))
        conv5.add_module('bn5_1', nn.BatchNorm2d(in_channels[3]))
        conv5.add_module('relu5_1', nn.ReLU())
        conv5.add_module('conv5_2', nn.Conv2d(in_channels[3], in_channels[3], 3, 1, 1))
        conv5.add_module('bn5_2', nn.BatchNorm2d(in_channels[3]))
        conv5.add_module('relu5_2', nn.ReLU())
        conv5.add_module('conv5_3', nn.Conv2d(in_channels[3], in_channels[3], 3, 1, 1))
        conv5.add_module('bn5_2', nn.BatchNorm2d(in_channels[3]))
    ...
    def _initialize_weights(self, pre_train):
        ...
        self.conv0.conv1_1.weight.data.copy_(pre_train[list(keys)[0]])
        ...
        self.conv0.conv1_1.bias.data.copy_(pre_train[list(keys)[1]])
