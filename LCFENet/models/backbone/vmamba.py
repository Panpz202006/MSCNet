...
class VSSM(nn.Module):
    def __init__(self, patch_size=4, in_chans=3, num_classes=1000, depths=[2, 2, 2, 2], 
                 dims=[32, 64, 128, 256],  d_state=16, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.1,
