...
class ISIC2018_Datasets(Dataset):
    def __init__(self,mode,transformer):
        super().__init__()
        # cwd=os.getcwd()
        cwd='/data_home/home/xyq1/models/xyq_folers/folder_model3/ARNet/CENet_CNN_ISIC2018'
...
class PH2_Datasets(Dataset):
    def __init__(self,mode,transformer):
        super().__init__()
        # cwd=os.getcwd()
        cwd='/data_home/home/xyq1/models/xyq_folers/folder_model3/ARNet/LCFENet_PH2'
